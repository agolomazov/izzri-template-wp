    ...
    <main class="main-content">
        <div class="main-content__wrapper clearfix">
            <div class="list-posts">
                        ...
                        <div class="post-item">
                            ...
                            >
                                ...
                                <div class="post-item__title">
                                    <h3 class="post-item__title-item"><a class="post-item__link" href="<?= the_permalink(); ?>"><?= the_title(); ?></a></h3>
                                </div>
                            ...
                            <div class="post-item__review-link">
                                <a href="<?= the_permalink(); ?>" class="read-more-link">Читать полностью</a>
                            </div>
                        </div>
                    <?php endwhile; ?>
                    <?php endif; ?>
                ...
                <div class="load-more">
                    <button class="load-more-posts">Загрузить ещё</button>
                </div>
            </div>
        </div>
    </main>
